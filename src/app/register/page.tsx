...
const Page = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    referralCode: '',
    userRole: '',
    accountType: 'company', // 'company' or 'agent'
    profileImage: null,
    certificate: null,
    // Company Info
    companyName: '',
  ...
  // 2. Filter steps dynamically based on accountType
  ...
  const handleNextStep = (stepData: any) => {
    ...
    // If we are on Personal (1) and user is an Agent, jump to Credentials (3)
  ...
  const handlePrevStep = () => {
    // If we are on Credentials (3) and user is an Agent, jump back to Personal (1)
  ...
  return (
    <div className="max-w-5xl w-full space-y-8 mx-auto p-4">
      ...
      {/* Step Indicators - Now uses index + 1 for display numbering */}
